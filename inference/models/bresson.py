...
class Bresson(nn.Module): 
    ...
    def __init__(self, dim_emb, dim_ff, nb_layers_encoder, nb_layers_decoder, nb_heads, dim_input_nodes=2, max_len_PE=1000, batchnorm=True, **kwargs):
